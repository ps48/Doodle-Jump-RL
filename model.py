...
class Deep_QNet(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv2d(4, 32, 8, 4, bias=True, padding=2)
        ...
        # self.fc4 = nn.ReLU(inplace=True)
        self.fc5 = nn.Linear(256, 3)
        
    def forward(self, x):
      
        # might have to reshape the input. Check with Pratik on how input will be then modify
        ...
        # fc4_res = self.fc4(flattened_res)
        fc5_res = self.fc5(F.relu(flattened_res))
